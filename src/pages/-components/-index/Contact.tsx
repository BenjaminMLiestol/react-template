...
export const Contact = (props: any) => {
	...
	return (
		<div>
			<div
				id="contact"
				className="pt-24 pb-52 gap-20 mx-auto max-w-[1170px] flex flex-col-reverse sm:flex-row justify-between px-5 sm:px-0"
			>
				<div>
					<div className="flex flex-col">
						...
						<p>
							Vennligst fyll ut skjemaet nedenfor for å sende oss en e-post, så vil vi kontakte deg
							så snart som mulig.
						</p>
					</div>
